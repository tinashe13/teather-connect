        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-bold mb-6 text-foreground">
              Our Innovation <span className="text-accent">Partners</span>
            </h2>
          ...
          >
            {partners.map((partner, index) => (
              <motion.div
                ...
                className="bg-card border border-border rounded-2xl p-6 flex items-center justify-center hover:border-accent/30 hover:shadow-lg transition-all duration-300 group aspect-square"
              >
